...
<div class="page">
   <div class="page-header">
      ...
      <div class="page-header-actions">
         <a href="{{url('/branch')}}" class="btn btn-primary">All Branches</a>
      </div>
   </div>
   <div class="page-content">
      <div class="panel">
         <div class="panel-body container-fluid">
            <form name="branch_form" id="branch_form" novalidate="true" autocomplete="off">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="form-group">
                        ...
                        <input type="text" name="branch_name" id="branch_name" class="form-control" required value="">
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="form-group">
               ...
               <div class="row">
                  ...
                  <div class="col-6" align="right">
                     <a href="javascript:void(0)" class="btn btn-primary" onclick="save_branch_data()">Save</a>
                  </div>
               </div>
            </form>
         </div>
...
<script type="text/javascript">
   ...
   function save_branch_data() {
      if (is_form_valid('branch_form') == 0) {
         var all_value = new FormData();
         var form_data = $('#branch_form').serializeArray();
   ...
   function getBranchOptions()
   {
      ...
      $.ajax({
         type: "POST",
         url: "{{route('get-branch-options')}}",
         data: {'_token' : '{{ csrf_token() }}','id' : id},
         dataType: 'json',
         success: function (msg) 
         {
            var company   = '<option value="">Select</option>';

            for (var i = 0; i < msg.data.length; i++) 
            {
               var value = msg.data[i];
               company   += '<option value="'+value.id+'">'+value.company_name+'</option>';
            }
         ...
         success: function (msg) 
         {
            if(msg.code==200)
            {
               if(msg.data.length>0)
               {
                  ...
                  $("#company").select2('val',[value.company]);
                  $("#branch_name").val(value.branch_name);
