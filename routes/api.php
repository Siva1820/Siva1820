...
Route::post('/validateLogin',[User::class,'validateLogin'])->name('api.validateLogin');

/*-------- Private Route ---------*/

// Route::group(['middleware' => 'thor'], function () {

	Route::post('/makeLogout',[User::class,'makeLogout'])->name('api.makeLogout');
